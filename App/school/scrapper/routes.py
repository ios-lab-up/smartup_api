...
@scrapper.route('/createCompatibleSchedule/<string:userID>', methods=['GET', 'POST'])
def createUserCompatibleSchedule(userID: str) -> dict[str, str]:
    '''This endpoint returns a compatible schedule for a user'''
